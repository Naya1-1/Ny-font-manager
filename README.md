...
*   **长期文字动画**：为已显示的正文/对话添加低能耗文字氛围，可设置全局效果，也可分别覆盖正文和对话。效果包括「呼吸微光」、「边缘辉光」、「流光扫过」、「墨迹浮动」、「烛火摇曳」、「纸张显影」、「寒霜脉冲」、「低频故障」。
...
*   **文字动画性能**：长期文字动画会限制作用范围以控制性能，主要同步最近的已完成聊天消息；正在流式输出的消息会优先使用流式动画。
